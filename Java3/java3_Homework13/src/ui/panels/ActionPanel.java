...
public class ActionPanel extends Panel implements Resettable {
	...
	public ActionPanel(final Model model) {
		...
		chkResize = new Checkbox(ShapeAction.RESIZE.getName(), actionGroup,
				false);
		chkRemove = new Checkbox(ShapeAction.REMOVE.getName(), actionGroup,
				false);
		chkChange = new Checkbox(ShapeAction.CHANGE.getName(), actionGroup,
				false);
