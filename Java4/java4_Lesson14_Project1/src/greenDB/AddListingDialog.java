...
class AddListingDialog extends JDialog {
		...
		addButton.addActionListener(
				new ActionListener() {
					public void actionPerformed(ActionEvent aEvent) {
						...
						String phone = areaCodeField.getText() + "-" + prefixField.getText() +"-"+ suffixField.getText();

						if(goodPhoneNumber(phone)){
							...
							JOptionPane.showMessageDialog(null,"Please enter numbers only for the phone number.");
						}
					}
				});
	...
	public String buildQuery() {
		...
		return new String("insert into Listings (LAST_NAME,FIRST_NAME,AREA_CODE,PREFIX,SUFFIX) " +
				"values ('" + last + "', '" +
				first + "', '" +
				ac + "', '" +
				pre + "', '" +
