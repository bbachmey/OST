...
public class OutputPanel extends JPanel {
    ...
    protected void writeOutput(){  
        ...
        txtOutput += "<br>The lowest sales belongs to sales person " + 
            (app.getMinIndex() + 1) + " with $" + sales[app.getMinIndex()] + "<br>";
        txtOutput += "The highest sales belongs to sales person " + 
            (app.getMaxIndex() + 1) + " with $" + sales[app.getMaxIndex()] + "<br>";
    ...
    protected String createSalesBarInfo(){                                               
        ...
        int overSalesBar = 0;
        int [] performance = app.calculateTopSalesPeople();
        ...
        if (overSalesBar ==1)
            salesBarOutput += "Only " + overSalesBar + 
                " sales person sold more than the sales goal of " + app.getSalesGoal() + "<br><br>";
        else
            salesBarOutput += overSalesBar + 
                " sales people sold more than the sales goal of " + app.getSalesGoal() + "<br><br>";
