...
public class InputPanel extends JPanel implements ActionListener  {
	...
	private void handleTfEvent(DocumentEvent e){
		...
		if(app.myUserInterface.currentValues==null){
			System.out.println("current values is null");			
		}
		else {
			app.myUserInterface.currentValues = sales;
		}
