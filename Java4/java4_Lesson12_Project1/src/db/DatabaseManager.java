...
public class DatabaseManager {
	...
	public boolean exists(String term){          
		boolean does = false;
		try {
			resultSet = statement.executeQuery("SELECT * FROM PhoneBook WHERE Name = '"+term+"' "); 
	...
	public void search(String term){                                               // returns a ResultSet containing all entries in the phone book
		try
		{
			resultSet = statement.executeQuery("SELECT * FROM PhoneBook WHERE Name = '"+term+"'"); // call the query and get a ResultSet
