...
public class SalesApp {
    ...
    public void calculateMinMax() {
        ...
        System.out.println("Maximum value is at index " + getMaxIndex()
            + " (Salesperson " + (getMaxIndex() + 1) + ") with value " + maximum);
        System.out.println("Minimum value is at index " + getMinIndex()
            + " (Salesperson " + (getMinIndex() + 1) + ") with value " + minimum);
        setAverage();
    }
